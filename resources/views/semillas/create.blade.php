...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <br>
            <div class="text-dark text-center  h3">AÑADE LA INFORMACÍON DE TU SEMILLA</div>
            <form action="{{ Route('semillas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        <label
                            class="uppercase md:text-sm text-xs text-dark text-light font-semibold">Descripción:</label>
                    ...
                    <div>
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-dark text-light font-semibold">Tiempo de
                                Germinacion:</label>
                            <input name="tiempo_germinacion"
                                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                type="text" required />
                        </div>
                    </div>
                ...
                <br>
                <div class="grid grid-cols-3 md:grid-cols-1 gap-5 md:gap-4 mt-2 mx-7">
                ...
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                    <a href="#"
                        ...
                        <button onclick="swal4()" type="submit"
