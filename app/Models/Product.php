...
class Product extends Model
{
    ...
    protected $fillable =['id','nombre','descripcion','price','categoria_id','cantidad','usos','preparacion','beneficios','cuidados','ubicacion','imagen']; // Permite hacer la asignacion masiva

    protected $allowIncluded = ['posts', 'posts.user']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id','nombre','descripcion','price','categoria_id','cantidad','usos','preparacion','beneficios','cuidados','ubicacion','imagen'];

    protected $allowSort = ['id','nombre','descripcion','price','categoria_id','cantidad','usos','preparacion','beneficios','cuidados','ubicacion','imagen'];
